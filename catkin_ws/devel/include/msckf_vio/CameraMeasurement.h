...
struct CameraMeasurement_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::msckf_vio::FeatureMeasurement_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::msckf_vio::FeatureMeasurement_<ContainerAllocator> >> _features_type;
